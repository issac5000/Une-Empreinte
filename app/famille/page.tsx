    ...
    <main className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 relative">
          ...
          <h1 className="title-font text-3xl md:text-5xl font-extrabold text-gray-800">Collection <span className="text-pink-500">Famille</span></h1>
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">Cadres personnalisés pour vos moments complices en famille.</p>
        </div>
